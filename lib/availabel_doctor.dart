import 'package:doctor_appointment/Home_Screen.dart';
import 'package:flutter/material.dart';

class AvailableDoctor extends StatefulWidget {
  AvailableDoctor({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _AvailableDoctorState createState() => _AvailableDoctorState();
}

class _AvailableDoctorState extends State<AvailableDoctor> {
  @override
